...
#define BT_NAME   "Slave" // bluetooth

const int RXPin = 53;     // da collegare su TX di HC05
const int TXPin = 52;     // da collegare su RX di HC05
...
int angoloDiTolleranza = 1; // angolo di tolleranza per destra e sinistra
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  Wire.write(0);     // Risveglia il sensore
  ...
  //int tempo = millis();
  //while (digitalRead(10)) {updateSensor();}
  */
...
void avantiMod(float distanza) {
  ...
  while (((newPosition-startingPosition)/6533.)*circonferenzaRuota < distanza) { 
    ...
    updateSensor();
    if (yaw_total - angoloDiTolleranza > startingYaw && !adjustB) { // ha virato a destra
      // dare più potenza al motore destro (enB)
      analogWrite(enB, potenzaEnB=potenzaEnB+30); 
    }  
    if (yaw_total + angoloDiTolleranza < startingYaw && !adjustA) { // ha virato a sinistra
      // dare più potenza al motore destro (enB)
      analogWrite(enA, potenzaEnA=potenzaEnA+30); 
      adjustA = true;
    }
    if (yaw_total + angoloDiTolleranza > startingYaw && yaw_total - angoloDiTolleranza < startingYaw) {
      adjustA = false;
      adjustB = false;
      potenzaEnB = 80;
      potenzaEnA = 80;
...
// meglio usare "aggiusta angolo" nel setup al posto di destra/sinistra 
// risolvere problema lasco andando per pochi millisecondi nella direzione opposta?
